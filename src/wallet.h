...
//! -maxtxfee default
static const CAmount DEFAULT_TRANSACTION_MAXFEE = 100000000000 * COIN;
...
enum AvailableCoinsType {
    ...
    ONLY_DENOMINATED = 2,
    ONLY_NOT10000IFMN = 3,
    ONLY_NONDENOMINATED_NOT10000IFMN = 4, // ONLY_NONDENOMINATED and not 10000 PRTX at the same time
